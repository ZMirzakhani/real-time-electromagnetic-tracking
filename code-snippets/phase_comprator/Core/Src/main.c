...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
volatile uint32_t ic1_val = 0;
volatile uint32_t ic2_val = 0;
...
void HAL_TIM_IC_CaptureCallback(TIM_HandleTypeDef *htim)
{
    if (htim->Instance == TIM1)
    {
        ...
        else if (htim->Channel == HAL_TIM_ACTIVE_CHANNEL_2)
        {
            ...
            time_diff = (ic2_val >= ic1_val) ? (ic2_val - ic1_val) : ((0xFFFF - ic1_val) + ic2_val);
            ic_done = 1;
...
int main(void)
{
  ...
  HAL_TIM_OC_Start(&htim23, TIM_CHANNEL_2);
...
static void MX_TIM23_Init(void)
{
  ...
  htim23.Init.Prescaler = 2-1;
  htim23.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim23.Init.Period = 27500;
...
static void MX_TIM24_Init(void)
{
  ...
  htim24.Init.Prescaler = 2-1;
  htim24.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim24.Init.Period = 27500;
  ...
  sSlaveConfig.InputTrigger = TIM_TS_ITR12;
